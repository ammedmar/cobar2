...
\section{Kan's loop group construction}\label{s:kan}
...
\]
defines a Quillen equivalence, where $\Top$ is equipped with the classical \textit{Quillen model structure} and $\sSet$ with the \textit{Kan--Quillen model structure}.
